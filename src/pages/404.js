  ...
  return (
    ...
    <div className='bg-black opacity-[65%] w-full h-full z-[2] absolute'/>
      ...
      <div className='flex w-full px-4 mlpx-theme-lg w-full xl:w-theme  flex-col items-start mt-[200px]  md:mt-[250px] z-[2] relative  '>
        <h1 className='text-title-h1-medium md:text-title-h1 text-white'>404</h1>
        <span className='text-title-h2-small md:text-title-h2-bold text-accent '>Hier hebben we nog geen pagina voor gemaakt</span>
