        ...
        <section className=' w-full 2xl:w-theme max-w-theme relative z-[1]  gap-8  mt-40 '>
          <div className='bg-primary w-full grid grid-cols-12 ' >
            <div className='flex flex-col justify-center items-center relative overflow-hidden col-span-12 p-5 gap-3 h-[240px] relative'>
              ...
              <Link href={'/contact'} id='Landings_pagina_cta' className={"text-regular-small flex items-center w-fit z-[2]  p-3 md:p-4 rounded-full border border-[2px] border-white bg-transparent text-white hover:bg-white hover:text-black transition-all"}>Ontdek meer</Link>
            </div>
          </div>
        </section>  
    </main>
